...
static const _FeatureQuality_type_support_symbol_names_t _FeatureQuality_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, vins, msg, FeatureQuality)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, vins, msg, FeatureQuality)),
  }
};
...
{
  return &::vins::msg::rosidl_typesupport_cpp::FeatureQuality_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, vins, msg, FeatureQuality)() {
  return get_message_type_support_handle<vins::msg::FeatureQuality>();
}
